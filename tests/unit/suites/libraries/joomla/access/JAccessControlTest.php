...
/**
 * Test class for \Joomla\CMS\Access\AccessControl.
 *
 * @package     Joomla.UnitTest
 * @subpackage  Access
 * @since       11.1
 */
class JAccessControlTest extends TestCaseDatabase
{
	/**
	 * @var    \Joomla\CMS\Access\AccessControl
	 * @since  11.1
	 */
	protected $object;
	...
	/**
	 * Tests the \Joomla\CMS\Access\AccessControl::getAuthorisedViewLevels method.
	 *
	 * @return  void
	 *
	 * @since   11.1
	...
	public function testGetAuthorisedViewLevels()
	{
		...
		$this->assertThat(
			\Joomla\CMS\Access\AccessControl::getAuthorisedViewLevels(42),
			$this->equalTo($array1),
	...
	public function casesCheck()
	{
		return array(
			...
			'null_asset' => array(42, 'core.admin', null, true, 'Line:' . __LINE__ . ' Null asset should default to root'),
	...
	/**
	 * Tests the \Joomla\CMS\Access\AccessControl::check method.
	 *
	...
	{
		$this->assertThat(\Joomla\CMS\Access\AccessControl::check($userId, $action, null, $assetId), $this->equalTo($result), $message);
	}
	...
	/**
	 * Tests the \Joomla\CMS\Access\AccessControl::checkGroup method.
	 *
	...
	{
		$this->assertThat(\Joomla\CMS\Access\AccessControl::checkGroup($groupId, $action, null, $assetId), $this->equalTo($result), $message);
	}

	/**
	 * Tests the \Joomla\CMS\Access\AccessControl::getAssetRules method.
	 *
	 * @return  void
	 *
	 * @since   11.1
	...
	{
		$ObjArrayJrules = \Joomla\CMS\Access\AccessControl::getAssetRules(null, 3, true);
	...
	{
		$ObjArrayJrules = \Joomla\CMS\Access\AccessControl::getAssetRules(null, 3, false);
	...
	{
		$ObjArrayJrules = \Joomla\CMS\Access\AccessControl::getAssetRules(null, 1550, false);
	...
	{
		$ObjArrayJrules = \Joomla\CMS\Access\AccessControl::getAssetRules(null, 'testasset', false);
	...
	{
		$ObjArrayJrules = \Joomla\CMS\Access\AccessControl::getAssetRules(null, 'testasset', true);
	...
	/**
	 * Tests the \Joomla\CMS\Access\AccessControl::getGroupTitle method.
	 *
	 * @return  void
	 *
	 * @since   11.1
	...
	{
		$this->assertThat(\Joomla\CMS\Access\AccessControl::getGroupTitle(1), $this->equalTo('Public'), 'Get group title. Line: ' . __LINE__);
	}

	/**
	 * Tests the \Joomla\CMS\Access\AccessControl::getUsersByGroup method.
	 *
	 * @return  void
	 *
	 * @since   11.1
	...
	{
		$array1 = array(0 => 42);
		$this->assertThat(\Joomla\CMS\Access\AccessControl::getUsersByGroup(8, true), $this->equalTo($array1), 'Get one user. Line: ' . __LINE__);
	}
	...
	public function testGetUsersByGroupTwoUsers()
	{
		...
		$this->assertThat(\Joomla\CMS\Access\AccessControl::getUsersByGroup(1, true), $this->equalTo($array3), 'Get multiple users. Line: ' . __LINE__);
	}
	...
	{
		$array2 = array();
		$this->assertThat(\Joomla\CMS\Access\AccessControl::getUsersByGroup(15, false), $this->equalTo($array2), 'No group specified. Line: ' . __LINE__);
	}

	/**
	 * Tests the \Joomla\CMS\Access\AccessControl::getGroupsByUser method.
	 *
	 * @return  void
	 *
	 * @since   11.1
	...
	public function testGetGroupsByUser()
	{
		...
		$this->assertThat(\Joomla\CMS\Access\AccessControl::getGroupsByUser(42, true), $this->equalTo($array1));

		$array2 = array(0 => 8);
		$this->assertThat(\Joomla\CMS\Access\AccessControl::getGroupsByUser(42, false), $this->equalTo($array2));

		$this->markTestSkipped('Test is now failing with full test suite.');

		$this->assertThat(\Joomla\CMS\Access\AccessControl::getGroupsByUser(null), $this->equalTo(array(1)));

		$this->assertThat(\Joomla\CMS\Access\AccessControl::getGroupsByUser(null, false), $this->equalTo(array(1)));
	}

	/**
	 * Data provider for the \Joomla\CMS\Access\AccessControl::getActionsFromData method.
	 *
	 * @return  array
	 *
	 * @since   12.1
	...
	/**
	 * Tests the \Joomla\CMS\Access\AccessControl::getActionsFromData method.
	 *
	...
	{
		$this->assertThat(\Joomla\CMS\Access\AccessControl::getActionsFromData($data, $xpath), $this->equalTo($expected), 'Line:' . __LINE__ . $msg);
	}

	/**
	 * Tests the \Joomla\CMS\Access\AccessControl::getActionsFromFile method.
	 *
	 * @return  void
	 *
	 * @since   12.1
	...
	{
		$this->assertThat(
			\Joomla\CMS\Access\AccessControl::getActionsFromFile('/path/to/unexisting/file'),
			$this->equalTo(false),
	...
	<section name="category">
		...
		$this->assertThat(
			\Joomla\CMS\Access\AccessControl::getActionsFromFile($this->outputPath . '/access.xml'),
			$this->equalTo(
				array(
					(object) array('name' => "core.admin", 'title' => "JACTION_ADMIN", 'description' => "JACTION_ADMIN_COMPONENT_DESC"),
					(object) array('name' => "core.manage", 'title' => "JACTION_MANAGE", 'description' => "JACTION_MANAGE_COMPONENT_DESC"),
	...
	protected function setUp()
	{
		...
		\Joomla\CMS\Access\AccessControl::clearStatics();

		$this->object = new \Joomla\CMS\Access\AccessControl;
